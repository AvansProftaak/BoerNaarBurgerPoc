    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="row account-profile-card">
                ...
                <div class="col pr-2">
                    <h2 class="pt-4 pl-4 data-headers">Wachtwoord wijzigen</h2>
                    <hr class="mx-2">
                    <form method="POST" action="<?php echo URLROOT; ?>/customers/changepassword">
                        ...
                        <!-- Current Password -->
                        <div class="col">
                            <label for="current_password" class="pl-2 user-data-header">Huidig wachtwoord<span class="pl-3 text-danger user-data-header"><?php echo $data['currentPasswordError'] ?></span></label>
                        ...
                        <!-- New Password -->
                        <div class="col">
                            <label for="password" class="pl-2 user-data-header">Nieuw wachtwoord<span class="pl-3 text-danger user-data-header"><?php echo $data['passwordError'] ?></span></label>
                        ...
                        <div class="col mb-3">
                            <label for="password-confirm" class="pl-2 user-data-header">Bevestig wachtwoord<span class="pl-3 text-danger user-data-header"><?php echo $data['confirmPasswordError'] ?></span></label>
                        ...
                        <div class="form-group row mb-3 justify-content-between">
                            <a type="button" href="<?php echo URLROOT; ?>/customers/accountdetails" class="mx-4 px-4 btn btn-bnb-secondary">Terug</a>
                            <button type="submit" name="submit-change-password" class="mx-4 px-4 btn btn-green">Wachtwoord Wijzigen</button>
                        </div>
                    </form>
                </div>
            </div>
