        ...
        <div class="col-md-8">
            <div class="row account-profile-card">
                ...
                <div class="col pr-2">
                    ...
                    <hr class="mx-2">
                    <form method="POST" action="<?php echo URLROOT; ?>/shopowners/changepassword">
                        <div class="col mt-3">
                        ...
                        <div class="form-group row mb-3 justify-content-between">
                            <a type="button" href="<?php echo URLROOT; ?>/shopowners/accountdetails" class="mx-4 px-4 btn btn-bnb-secondary"><?php echo $lang['back']; ?></a>
