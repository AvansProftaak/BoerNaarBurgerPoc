                    ...
                    <form method="POST" enctype="multipart/form-data" action="<?php echo URLROOT . '/shopowners/editproduct?product=' . $_GET['product'] ?>">
                        ...
                        <div class="form-group row mx-1">
                            <div class="col-5">
                                ...
                                <input id="product_name_nl" type="text" class="form-control rounded-borders input-icon-nl <?php if($data['product_nameError']) : ?> is-invalid <?php endif; ?>" name="product_name_nl" placeholder="Aardappelen loket" autocomplete="shop_name" value="<?php echo $data['product_name_nl']; ?>">
                                <input id="product_name_en" type="text" class="mt-2 form-control rounded-borders input-icon-en <?php if($data['product_nameError']) : ?> is-invalid <?php endif; ?>" name="product_name_en" placeholder="Aardappelen loket" autocomplete="shop_name" value="<?php echo $data['product_name_en']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mx-1">
                            ...
                            <div class="col-5">
                                ...
                                <input id="product_description_nl" type="text" class="form-control rounded-borders input-icon-nl" name="product_description_nl" placeholder="Ik heb lekkere aardappelen" autocomplete="product_description_nl" value="<?php echo $data['product_description_nl']; ?>">
                                <input id="product_description_en" type="text" class="mt-2 form-control rounded-borders input-icon-en" name="product_description_en" placeholder="Ik heb lekkere aardappelen" autocomplete="product_description_en" value="<?php echo $data['product_description_en']; ?>">
                        ...
                        <div class="form-group row mx-1 mb-0">
                            ...
                            <div class="col-5">
                                ...
                                <input id="product_price" type="text" class="form-control rounded-borders" name="product_price" placeholder="1,50" autocomplete="product_price" value="<?php echo $data['product_price']; ?>">
                            </div>
                            ...
                            <div class="col-5">
                                ...
                                <input id="product_stock" type="text" class="form-control rounded-borders" name="product_stock" placeholder="150" autocomplete="product_stock" value="<?php echo $data['product_stock']; ?>">
                            </div>
                        </div>
                            <!-- eddit Button -->
